class CustomMarkovChain:
    ...
    def __init__(self, proposal, is_valid, constraints, accept, initial_state, total_steps=1000):
        """
    ...
    def __next__(self):
        ...
        while self.counter < self.total_steps:
            ...
            if self.counter > 40000:
                beta = 1 - (60000-self.counter)/20000
                #linearly to 1
            ...
            if not proposal:
                if self.accept(self.state, beta):
                    self.counter += 1
                    return self.state
                else:
                    continue
            ...
            if self.is_valid(proposed_next_state):
                if self.constraints(proposed_next_state):
                    proposed_next_state.accepted = self.accept(proposed_next_state, beta)
